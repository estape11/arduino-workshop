...
void setup()
 ...
 void loop()
 {
   ...
   distance = (duration/2) / 29.1;     //distance is the duration divided by 2 because the signal traveled from the trigpin then back to the echo pin, then divide by 29.1 to convert to centimeters
